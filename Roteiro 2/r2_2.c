...
void main (void)
{
	...
	while(1){
		switchs = ~P2; 																	// switchs armazena P2 (porta q le o valor das chaves). ex: se todas estão fechadas
		...
		switchs = switchs & 0x0F;												// estou pegando os digitos mais significativos da leitura de P2 e mascarando
																										...
																										// com &    0 0 0 0 1 1 1 1
																										// ficamos  0 0 0 0 x x x x porque tanto faz E 0 dá zero, enquanto tanto faz E 1 dá tanto faz
